...
int TideIndexApplication::main(
        ...
        if (out_target_list) {
                ...
                HeadedRecordReader reader(peakless_peptides, NULL); //src/app/tide/records.h line 191
                while (!reader.Done()) {
                        pb::Peptide* protobuf = new pb::Peptide;
                        reader.Read(protobuf); //src/app/tide/records.h line 165 Using google coded buffer
...
void TideIndexApplication::generateDecoys(
        ...
        if (decoyCheck != targetToDecoy.end()) {
                ...
                // Map of peptide and a vector of decoys
