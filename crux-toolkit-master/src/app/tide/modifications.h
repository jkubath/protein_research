...
public:
        ...
        const pb::ModTable* ParsedModTable() const {
                return &pb_mod_table_;
        }
        const pb::ModTable* ParsedNtpepModTable() const {
                return &pb_ntpep_mod_table_;
        }
        const pb::ModTable* ParsedCtpepModTable() const {
                return &pb_ctpep_mod_table_;
        }
        ...
        int Unique_delta_size() {
                return unique_delta_.size();
        }
private:
